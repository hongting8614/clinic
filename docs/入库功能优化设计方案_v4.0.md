...
|------|---------|---------|------|---------|
| 方案1 | **药品入库单** | Drug Inbound | 最直观，符合业务习惯 | ⭐⭐⭐⭐⭐ |
...
| 药品行组件 | `components/drug-row/index.vue` | 单行药品信息 |
