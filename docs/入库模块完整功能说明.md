...
入库模块已完成从旧卡片式UI到新表格式UI的全面重构，实现了完整的双签名审核流程和多种药品录入方式。
...
#### 📋 从档案选择
- 导航到药品列表页（`pages-sub/drug/list.vue?mode=select`）
- 支持搜索（名称/拼音）和分类筛选
...
- 药品列表页: `pages-sub/drug/list.vue` - `mode='select'`
...
<template>
  <view class="container">
    ...
    <view class="page-header">
      ...
      <view class="page-subtitle">北京欢乐谷医务室 · 药品入库单</view>
    </view>
