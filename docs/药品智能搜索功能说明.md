...
在**药品入库**页面新增智能搜索功能，用户可以通过输入药品名称或拼音首字母快速搜索并选择药品，选择后下拉列表自动隐藏，药品详情默认折叠，提升录入效率。
...
第3步：下拉列表自动消失，药品添加到列表
┌─────────────────────────────────────┐
│ 🔍 [              ]                 │  ← 搜索框已清空
└─────────────────────────────────────┘

┌─────────────────────────────────────┐
│ 💊 阿莫西林胶囊  0.5g*12粒    [删除] │  ← 药品已添加
│ [展开详情 ▼]                         │  ← 默认折叠
├─────────────────────────────────────┤
│ 批号 *      [              ]         │  ← 直接填写
│ 生产日期 *  [选择]                   │
