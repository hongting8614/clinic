...
var _add = _interopRequireDefault(__webpack_require__(/*! ./pages-sub/clinic/add.vue */ 388));
// @ts-ignore
...
/* harmony import */ var _add_vue_vue_type_template_id_0904e2e0_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add.vue?vue&type=template&id=0904e2e0&scoped=true& */ 389);
/* harmony import */ var _add_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add.vue?vue&type=script&lang=js& */ 391);
...
/* harmony import */ var _add_vue_vue_type_style_index_0_id_0904e2e0_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add.vue?vue&type=style&index=0&id=0904e2e0&lang=scss&scoped=true& */ 393);
...
var render = function () {
  ...
  var m7 = _vm.selectedBatch
    ? _vm.formatDate(_vm.selectedBatch.expireDate)
    : null
  if (!_vm._isMounted) {
...
var _default = {
      ...
      if (oldComplaint && !newComplaint) {
        ...
        if (hasRelatedData) {
          ...
          this.$nextTick(function () {
            // 检查是否有可保存的模板内容
            var disease = (_this2.form.diseaseName || '').trim();
            var complaint = (_this2.form.chiefComplaint || '').trim();
            var diagnosis = (_this2.form.diagnosis || '').trim();
            var treatment = (_this2.form.treatment || '').trim();
            var canSaveTemplate = disease && (complaint || diagnosis || treatment);
            if (canSaveTemplate) {
  ...
  methods: (_methods = {
    ...
    clearAllRelatedFields: function clearAllRelatedFields() {
      // 在连续登记模式下，保留疾病相关信息
      var preserveDisease = this.continueAfterSubmit;
      var savedDiseaseName = preserveDisease ? this.form.diseaseName : '';
      var savedDiagnosis = preserveDisease ? this.form.diagnosis : '';
      var savedTreatment = preserveDisease ? this.form.treatment : '';
    ...
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee9() {
      var showLoading, res, batches, parkName;
