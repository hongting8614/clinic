  ...
  methods: {
    ...
    confirmCreate: function confirmCreate() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var db, existCheck, barcodeCheck, drugCode, result, newDrugItem;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!(!_this4.newDrug.name || !_this4.newDrug.spec || !_this4.newDrug.manufacturer || !_this4.newDrug.unit)) {
                  _context2.next = 3;
                  break;
                }
                uni.showToast({
              ...
              case 21:
                ...
                // 如果没有药材代码，自动生成
                drugCode = _this4.newDrug.drugCode || _this4.generateDrugCode();
                _context2.next = 25;
    ...
    generateDrugCode: function generateDrugCode() {
      ...
      var name = this.newDrug.name;
      var spec = this.newDrug.spec;
